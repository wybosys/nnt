...
@interface NNTUITabBarItem : UIBevelButton {
    ...
    NgMutableTextStyle *normalTitleStyle;
    
    //! selected style for title.
    NgMutableTextStyle *selectedTitleStyle;
...
@property (nonatomic, retain) NgMutableTextStyle *normalTitleStyle, *selectedTitleStyle;
