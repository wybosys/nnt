 ...
 *
 *  In general, you will want to create a WCGMutableLineStyle if you want to customize properties.
 **/

@implementation WCGLineStyle
...
/** @brief Creates and returns a new WCGLineStyle instance.
 *  @return A new WCGLineStyle instance.
 **/
+ (id)lineStyle
{
...
- (id)init
{
    ...
    dashPattern = nil;
    patternPhase = 0.0;
    lineColor = [[WCGColor blackColor] retain];
...
{
    WCGLineStyle *styleCopy = [[WCGLineStyle allocWithZone:zone] init];
...
{
    WCGLineStyle *styleCopy = [[WCGMutableLineStyle allocWithZone:zone] init];
...
@implementation WCGMutableLineStyle
