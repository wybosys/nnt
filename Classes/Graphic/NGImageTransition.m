...
# import "Core.h"
# import "NGImageTransition.h"
# import <QuartzCore/QuartzCore.h>

NNT_BEGIN_OBJC

const CFTimeInterval kNgImageTransitionDefaultDuration = 1.f;

@interface NgImageTransitionPrivate : NSObject {
    NgImageTransition *d_owner;
...
@property (nonatomic, assign) NgImageTransition *d_owner;
...
@implementation NgImageTransitionPrivate
...
- (void)pack {
    ...
    id<NgImageTransitionDelegate> delegate = d_owner.delegate;
...
# endif
    ...
    NgImageTransitionLineOffset offset_l = d_owner.offset_left, offset_r = d_owner.offset_right;
    void *offset_context = d_owner.offset_context;
    uint counter = d_owner.counter;
    
    NgImageTransitionLineOffsetParam param;
...
@implementation NgImageTransition
...
- (id)init {
    self = [super init];
    NNTDECL_PRIVATE_INIT(NgImageTransition);
    
    proc_line = (NgImageTransitionLineProc)kARGBLineDoubleInsetProc;
    duration = kNgImageTransitionDefaultDuration;
...
int kOffsetZero(NgImageTransitionLineOffsetParam* param) {
    return 0;
}
