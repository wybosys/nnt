...
/** @brief Initializes a WCGImage instance with the provided CGImageRef.
 *
 *	This is the designated initializer.
 *
 *  @param anImage The image to wrap.
 *  @return A WCGImage instance initialized with the provided CGImageRef.
 **/
...
/** @brief Initializes a WCGImage instance with the contents of a PNG file.
 *  @param path The file system path of the file.
 *  @return A WCGImage instance initialized with the contents of the PNG file.
 **/
...
- (id)copyWithZone:(NSZone *)zone {
    WCGImage *copy = [[[self class] allocWithZone:zone] init];
...
/** @brief Creates and returns a new WCGImage instance initialized with the provided CGImageRef.
 *  @param anImage The image to wrap.
 *  @return A new WCGImage instance initialized with the provided CGImageRef.
 **/
+ (WCGImage *)imageWithCGImage:(CGImageRef)anImage {
	return [[[self alloc] initWithCGImage:anImage] autorelease];
}

/** @brief Creates and returns a new WCGImage instance initialized with the contents of a PNG file.
 *  @param path The file system path of the file.
 *  @return A new WCGImage instance initialized with the contents of the PNG file.
 **/
...
WCGImage* WCGMaskImage(CGImageRef dst, CGImageRef src) {
    ...
    CGImageRelease(mask);
    WCGImage* image = [WCGImage imageWithCGImage:masked];
...
WCGImage* WCGImageLoadPngData(byte const* data, usize const len) {
    ...
    if (cgImage == NULL)
        return nil;
    WCGImage* image = [WCGImage imageWithCGImage:cgImage];
    CGImageRelease(cgImage);
    return image;
}
