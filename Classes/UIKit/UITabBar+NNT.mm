...
signal_t kSignalArrowMoving = @"::nnt::ui::arrow:moving";
signal_t kSignalArrowMoved = @"::nnt::ui::arrow:moved";
...
- (void)drawRect:(CGRect)rect {
    ...
    NgTextStyle *theNormalTs = self.normalTitleStyle;
    NgTextStyle *theSelectedTs = self.selectedTitleStyle ? self.selectedTitleStyle : theNormalTs;                 
