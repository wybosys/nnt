...
signal_t kSignalImageCacheLoaded = @"::wsi::ui::image::cacheloaded";
signal_t kSignalActiveScale = @"::wsi::ui::scale::active";
signal_t kSignalImageFetchedError = @"::wsi::ui::image::fetch::error";
