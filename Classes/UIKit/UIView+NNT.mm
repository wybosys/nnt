...
signal_t kSignalViewClicked = @"::nnt::ui::view::clicked";
signal_t kSignalButtonClicked = @"::nnt::ui::view::clicked"; // must same as kSignalViewClicked.
signal_t kSignalSelectChanged = @"::nnt::ui::select::changed";
signal_t kSignalFrameChanged = @"::nnt::ui::frame::changed";
signal_t kSignalBoundsChanged = @"::nnt::ui::bounds::changed";
signal_t kSignalSelected = @"::nnt::ui::selected";
signal_t kSignalDeselected = @"::nnt::ui::selected";
signal_t kSignalPainting = @"::nnt::ui::draw";
