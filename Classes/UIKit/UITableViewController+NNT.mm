...
signal_t kSignalItemRemoving = @"::nnt::ui::item::removing";
signal_t kSignalItemRemoved = @"::nnt::ui::item::removed";
signal_t kSignalItemInserted = @"::nnt::ui::item::inserted";
signal_t kSignalItemMoved = @"::nnt::ui::item::moved";
