...
# ifndef __WSI_UIKIT_COVERDRAWERITEM_D561E46E27B640F2A8EE8587BE997738_H_INCLUDED
# define __WSI_UIKIT_COVERDRAWERITEM_D561E46E27B640F2A8EE8587BE997738_H_INCLUDED

# import "UIView+WSI.h"

WSI_BEGIN_HEADER_OBJC

WSIDECL_PRIVATE_HEAD(UICoverDrawerItem);
WSIDECL_EXTERN_CLASS(UICoverDrawer);
WSIDECL_EXTERN_CLASS(WCGLineStyle);

@interface UICoverDrawerItem : WSIUIView {
    ...
    WSIDECL_PRIVATE(UICoverDrawerItem);
