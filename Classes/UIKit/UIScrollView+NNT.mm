...
signal_t kSignalBeginScroll = @"::nnt::ui::scroll:begin";
signal_t kSignalEndScroll = @"::nnt::ui::scroll::end";
...
- (void)setTopHeaderView:(UIHeaderView*)view {
    ...
    _topHeaderView.direction = NgDirectionTop;
}
...
- (void)setBottomHeaderView:(UIHeaderView*)view {
    ...
    _bottomHeaderView.direction = NgDirectionBottom;
}
