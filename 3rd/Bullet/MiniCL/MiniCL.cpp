...
static char* spPlatformID = (char*)"MiniCL, SCEA";
static char* spDriverVersion= (char*)"1.0";
...
//	int maxNumOutstandingTasks = 1;
	...
	static char const* sUniqueThreadSupportName[maxNumOfThreadSupports] = 
	{
...
# endif
	...
	{
		SequentialThreadSupport::SequentialThreadConstructionInfo stc((char*)"MiniCL",processMiniCLTask,createMiniCLLocalStoreMemory);
