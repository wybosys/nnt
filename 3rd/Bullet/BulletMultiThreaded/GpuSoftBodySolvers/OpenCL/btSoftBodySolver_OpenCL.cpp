...
#define MSTRINGIFY(A) #A
static char const* PrepareLinksCLString = 
#include "OpenCLC10/PrepareLinks.cl"
static char const* UpdatePositionsFromVelocitiesCLString = 
#include "OpenCLC10/UpdatePositionsFromVelocities.cl"
static char const* SolvePositionsCLString = 
#include "OpenCLC10/SolvePositions.cl"
static char const* UpdateNodesCLString = 
#include "OpenCLC10/UpdateNodes.cl"
static char const* UpdatePositionsCLString = 
#include "OpenCLC10/UpdatePositions.cl"
//static char const* UpdateConstantsCLString = 
//#include "OpenCLC10/UpdateConstants.cl"
static char const* IntegrateCLString = 
#include "OpenCLC10/Integrate.cl"
static char const* ApplyForcesCLString = 
#include "OpenCLC10/ApplyForces.cl"
static char const* UpdateNormalsCLString = 
#include "OpenCLC10/UpdateNormals.cl"
//static char const* VSolveLinksCLString = 
...
void btOpenCLSoftBodySolver::optimize( btAlignedObjectArray< btSoftBody * > &softBodies )
{
	if( m_softBodySet.size() != softBodies.size() )
	{
		...
		for( int softBodyIndex = 0; softBodyIndex < softBodies.size(); ++softBodyIndex )
		{
			...
			int maxLinks = numLinks; maxLinks = maxLinks;
...
void btOpenCLSoftBodySolver::updateSoftBodies()
{
	...
	int numTriangles = m_triangleData.getNumTriangles(); numTriangles = numTriangles;
...
void btOpenCLSoftBodySolver::solveConstraints( float solverdt )
{
	...
	// Prepare links
	int numLinks = m_linkData.getNumLinks(); numLinks = numLinks;
	int numVertices = m_vertexData.getNumVertices(); numVertices = numVertices;
